...
> **Input template for Workflow 1.5 (`/experiment-bridge`).** Fill in, save as `refine-logs/EXPERIMENT_PLAN.md`.
>
> Compiled FarField output (`EXPERIMENT_PLAN.md` and `EXPERIMENT_PLAN_EN.md`) is self-contained: claim, arms, blocks, run order, budget, and risks are all in this file. The same blocks are also inlined into the research plan.
