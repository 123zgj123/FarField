# Research Brief / Research Plan (input template)
...
>
> Compiled FarField output (`idea-stage/RESEARCH_BRIEF.md` and `RESEARCH_BRIEF_EN.md`) inlines the experiment design, literature, world, and next steps in one file, in both Chinese and English. Do not compile "see the other file" in place of those sections.
>
