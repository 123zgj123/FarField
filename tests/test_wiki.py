...
from farfield.extras.wiki import block, gap_lines, limitation_sentences, merge_works, prompt_lines
from tests.test_generate import FakeClient, LABELS, answer
from tests.test_mission import FakeFeed, SchemingClient, TOPIC, run_mission
            ...
            def survey_around(self, concept_a, concept_b, **kwargs):
                return [
                    FreshWork(
                        ...
                        arxiv_id="2601.00001",
                        abstract=(
                            "We encode pivot logs. However, we do not evaluate "
                            "query time on public traces."
                        ),
                    )
                ]
